...
import { Save, Power, LogOut, CheckCircle2, MessageSquare, AlignLeft, Loader2 } from 'lucide-react'
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-slate-400 font-bold text-sm">Manajemen Lapak</p>
          </div>
          <button 
            onClick={onLogout}
        ...
        {/* Action Button */}
        <div className="fixed bottom-0 left-0 right-0 p-6 bg-white/80 backdrop-blur-md border-t border-slate-100">
          <div className="max-w-2xl mx-auto">
            <button
              disabled={loading}
